...
# from attention_modules.EMCA import BasicResidualECABlock
...
class PointNetSetAbstraction(nn.Module):
    ...
    def __init__(self, npoint, radius, nsample, in_channel, mlp, group_all, att_block_types):
        ...
        self.mlp_attention = nn.ModuleList()
        self.att_block_types=att_block_types
        ...
        for out_channel in mlp:
            ...
            if(self.att_block_types=='scSE'):
                self.mlp_attention.append(scSE(out_channel))
            elif(self.att_block_types=='ECA_scSE'):
                self.mlp_attention.append(ECA_scSE(out_channel))
            elif(self.att_block_types=='ECANet'):
                self.mlp_attention.append(eca_layer(out_channel))
            elif(self.att_block_types=='SENet'):
                self.mlp_attention.append(SELayer(out_channel))
            elif(self.att_block_types=='CBAM'):
                self.mlp_attention.append(CBAM(out_channel))
            # elif(self.att_block_types=='ECA_ResNet'):
            #     self.mlp_attention.append(eca_resnet50(num_classes=out_channel))
            # elif(self.att_block_types=='GAM'):
            #     self.mlp_attention.append(GAM(out_channel,out_channel))
            # elif(self.att_block_types=='BAM'):
            #     self.mlp_attention.append(BAM(out_channel))
            # elif(self.att_block_types=='EMCA'):
            #     self.mlp_attention.append(BasicResidualECABlock(out_channel,out_channel,1,2))
    ...
    def forward(self, xyz, points):
        ...
        for i, conv in enumerate(self.mlp_convs):
            bn = self.mlp_bns[i]
            if(self.att_block_types=='noAttention' or self.att_block_types=='NONE'):
                new_points = F.relu(bn(conv(new_points))) 
            else:
                attention = self.mlp_attention[i]
                new_points =  F.relu(bn(attention(conv(new_points))))
...
class PointNetSetAbstractionMsg(nn.Module):
    ...
    def __init__(self, npoint, radius_list, nsample_list, in_channel, mlp_list, att_block_types):
        ...
        for i in range(len(mlp_list)):
            ...
            for out_channel in mlp_list[i]:
                ...
                # add attention layers 
                if(self.att_block_types=='scSE'):
                    attentions.append(scSE(out_channel))
                elif(self.att_block_types=='ECA_scSE'):
                    self.mlp_attention.append(ECA_scSE(out_channel))
                elif(self.att_block_types=='ECANet'):
                    attentions.append(eca_layer(out_channel))
                elif(self.att_block_types=='SENet'):
                    attentions.append(SELayer(out_channel))
                elif(self.att_block_types=='CBAM'):
                    attentions.append(CBAM(out_channel))
                # elif(self.att_block_types=='BAM'):
                #     attentions.append(BAM(out_channel))
                # elif(self.att_block_types=='ECA_ResNet'):
                #     attentions.append(eca_resnet50(num_classes=out_channel))
                # elif(self.att_block_types=='GAM'):
                #     attentions.append(GAM(out_channel,out_channel))
                # elif(self.att_block_types=='noAttention' or self.att_block_types=='NONE'):
                #     # do nothing
                #     pass   
                # elif(self.att_block_types=='EMCA'):
                #     attentions.append(BasicResidualECABlock(out_channel,out_channel,1,2))

                bns.append(nn.BatchNorm2d(out_channel))
                last_channel = out_channel
            self.conv_blocks.append(convs)
            self.attention_blocks.append(attentions)
        ...
        for i, radius in enumerate(self.radius_list):
            ...
            for j in range(len(self.conv_blocks[i])):
                ...
                if(self.att_block_types=='noAttention' or self.att_block_types=='NONE'):
                    ...
                    attention = self.attention_blocks[i][j]
                    grouped_points =  F.relu(bn(attention(conv(grouped_points))))
            # 最大池化，獲得局部區域的全局特徵
...
class PointNetFeaturePropagation(nn.Module):
    def __init__(self, in_channel, mlp, att_block_types):
        ...
        for out_channel in mlp:
            ...
            #         # do nothing
            #         pass
                # self.mlp_attention.append(GAMFP(out_channel,out_channel))
            # elif(self.att_block_types=='EMCA'):
            #     self.mlp_attention.append(BasicResidualECABlock(out_channel,out_channel,1,2))
